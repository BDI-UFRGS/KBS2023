...
from model.multiclass.BERT import BERT_model
...
class BERT_exp():
    ...
    def run(self):    
        ...
        for x_train, y_train, x_test, y_test in dataset.split_n_folds(self.folds):
            ...
            model = BERT_model(self.model_name, len(dataset.class_names()), trainable=self.trainable).get_model()
